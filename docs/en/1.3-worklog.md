...
[Jul 30](https://www.weigao.cc/blog/2018/07/25/flask.html#flask_bootstrap) add new function into `bootstrap_test` branch; init the app by flask extend; `Flask-Moment` to show time format



[August](#){:.button.button--outline-success.button--pill}

[Aug 1]() potluck with Xinmeng Zhao; Flask MongoDB init